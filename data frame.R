...
# Here names signifies for column names 
...
head(df) #head command gives top 6 rows

head(df,n=3) #top 3 rows

tail(df) # tail command gives last 6 rows

tail(df,n=2) #last 2 rows

View(df) #To view data set in table form in new tab
